...
function toast(a, b, c, d) {
    function e(a) {
        ...
        return b.hammer({prevent_default: !1}).bind("pan", function (a) {
            ...
            var c = a.gesture.deltaX, d = 80;
            Math.abs(c) > d ? b.velocity({marginTop: "-40px"}, {
                duration: 375,
                easing: "easeOutExpo",
                queue: !1,
                complete: function () {
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    a.fn.dropdown = function (b) {
        var c = {inDuration: 300, outDuration: 225, constrain_width: !0, hover: !0};
        b = a.extend(c, b), this.each(function () {
            ...
            var e = a(this), f = a("#" + e.attr("data-activates"));
    ...
    a.fn.extend({
        ...
        closeModal: function (b) {
            ...
            a("#lean-overlay").velocity({opacity: 0}, {
                ...
                a(this).css({top: 0}), a("#lean-overlay").css({display: "none"}), "function" == typeof b.complete && b.complete()
            })
        }
    }), a.fn.extend({
    ...
    a.fn.parallax = function () {
        ...
        return this.each(function () {
            function c(c) {
                if (b > 992) {
                    var e = d.height(), f = d.children("img").height(), g = f - e, h = d.offset().top + e, i = d.offset().top, j = a(window).scrollTop(), k = window.innerHeight, l = j + k, m = (l - i) / (e + k), n = -1 * g * m;
    ...
    a.fn.tooltip = function (e) {
        ...
        return e = a.extend(g, e), this.each(function () {
            var e = a(this), h = a("<div></div");
            h.addClass("material-tooltip").text(e.attr("data-tooltip")), h.appendTo(a("body"));
            var i = a("<div></div").addClass("backdrop");
            i.appendTo(h), i.css({top: 0, left: 0}), a(this).hover(function (a) {
                a.stopPropagation(), b = 0, d = setInterval(function () {
                    if (b += 50, b >= g.delay && 0 == c) {
                        c = !0, h.css({display: "block", left: "0px", top: "0px"});
                        var a = e.outerWidth(), d = e.outerHeight(), j = e.attr("data-position"), k = h.outerHeight(), l = h.outerWidth(), m = "0px", n = "0px", o = 8;
                        "top" === j ? (h.css({
                            ...
                            left: e.offset().left + a / 2 - l / 2
                        }), console.log(e.offset().left), console.log(a / 2), console.log(l / 2), m = "+10px", i.css({marginLeft: l / 2 - i.width() / 2})), o = l / 8, 8 > o && (o = 8), ("right" === j || "left" === j) && (o = l / 10, 6 > o && (o = 6)), h.velocity({
                            opacity: 1,
                            marginTop: m,
                            marginLeft: n
                        }, {duration: 350, queue: !1}), i.css({display: "block"}).velocity({opacity: 1}, {
                            duration: 55,
                            delay: 0,
                            queue: !1
                ...
                clearInterval(d), b = 0, h.velocity({opacity: 0, marginTop: 0, marginLeft: 0}, {
                    duration: 225,
                    queue: !1,
                    delay: 275
    ...
    var f = f || {}, g = document.querySelectorAll.bind(document), h = {
        duration: 700, show: function (a) {
            if (2 === a.button)return !1;
            var b = this, c = document.createElement("div");
            c.className = "waves-ripple", b.appendChild(c);
            var f = d(b), g = a.pageY - f.top, h = a.pageX - f.left, i = "scale(" + b.clientWidth / 100 * 22 + ")";
            ...
            if (!b)return !1;
            var f = b.getAttribute("data-x"), g = b.getAttribute("data-y"), i = b.getAttribute("data-scale"), j = Date.now() - Number(b.getAttribute("data-hold")), k = 500 - j;
    ...
    function c(a) {
        for (var c = g.length; c--;)if (a.keyCode === g[c])return void b(a)
    }
    ...
    a.fn.sideNav = function (b) {
        ...
        b = a.extend(c, b), a(this).each(function () {
            function c() {
                a("#sidenav-overlay").animate({opacity: 0}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeOutQuad",
                    complete: function () {
                ...
                }), "left" === b.edge ? g.velocity({left: -1 * (h + 10)}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeOutQuad"
                }) : g.velocity({right: -1 * (h + 10)}, {duration: 300, queue: !1, easing: "easeOutQuad"}), f()
            }

            var d = a(this), g = a("#" + d.attr("data-activates")), h = g.width();
            ...
            var i = !1, j = !1;
            a("nothing").hammer({prevent_default: !1}).bind("pan", function (d) {
                if ("touch" === d.gesture.pointerType) {
                    {
                        var e = d.gesture.direction, f = d.gesture.center.x;
                        d.gesture.center.y
                    }
                    if (i) {
                        if (!a("#sidenav-overlay").length) {
                            ...
                            k.css("opacity", 0).click(function () {
                                i = !1, j = !1, c(), "left" === b.edge ? g.velocity({left: -1 * h}, {
                                    duration: 300,
                                    queue: !1,
                                    easing: "easeOutQuad"
                                }) : g.velocity({right: -1 * h}, {
                                    duration: 300,
                                    queue: !1,
                                    easing: "easeOutQuad"
                                }), k.animate({opacity: 0}, {
                        ...
                        f > h ? f = h : 0 > f ? f = 0 : h / 2 > f ? j = !1 : f >= h / 2 && (j = !0), "left" === b.edge ? g.velocity({left: -1 * h + f}, {
                            duration: 50,
                            queue: !1,
                            easing: "easeOutQuad"
                        }) : g.velocity({right: -1 * h + f}, {duration: 50, queue: !1, easing: "easeOutQuad"});
                        var l = f / h;
                        a("#sidenav-overlay").velocity({opacity: l}, {duration: 50, queue: !1, easing: "easeOutQuad"})
                    } else j ? d.gesture.center.x > h - b.activationWidth && 2 === e && (i = !0) : d.gesture.center.x < b.activationWidth && 4 === e && (i = !0)
                }
            }).bind("panend", function (b) {
                "touch" === b.gesture.pointerType && (i = !1, j ? (g.velocity({left: 0}, {
                    duration: 300,
                    queue: !1,
                    easing: "easeOutQuad"
                ...
                if (g.hasClass("active"))j = !1, i = !1, c(); else {
                    e(), "left" === b.edge ? g.velocity({left: 0}, {
                        duration: 300,
                        queue: !1,
                        easing: "easeOutQuad"
                    }) : g.velocity({right: 0}, {duration: 300, queue: !1, easing: "easeOutQuad"});
                    var d = a('<div id="sidenav-overlay"></div>');
                    d.css("opacity", 0).click(function () {
                        j = !1, i = !1, c(), d.animate({opacity: 0}, {
                            duration: 300,
                            queue: !1,
                            easing: "easeOutQuad",
                            complete: function () {
        ...
        a(document).on("mousedown", h, function (b) {
            ...
            a(this).each(function () {
                if ($select = a(this), !$select.hasClass("browser-default") && !$select.hasClass("initialized")) {
                    var b = i(), c = a('<div class="select-wrapper"></div>'), d = a('<ul id="select-options-' + b + '" class="dropdown-content select-dropdown"></ul>'), e = $select.children("option");
                    if (void 0 !== $select.find("option:selected"))var f = $select.find("option:selected"); else var f = d.first();
                    e.each(function () {
                    ...
                    $select.before(g), a("body").append(d), $select.is(":disabled") || g.dropdown({hover: !1}), $select.addClass("initialized")
                }
            })
        };
        var i = function () {
    ...
    a(document).ready(function () {
        a(document).on("click.card", ".card", function (b) {
            a(this).find(".card-reveal").length && (a(b.target).is(a(".card-reveal .card-title")) || a(b.target).is(a(".card-reveal .card-title i")) ? a(this).find(".card-reveal").velocity({translateY: 0}, {
                ...
                queue: !1,
                easing: "easeOutQuad"
            }) : (a(b.target).is(a(".card .card-title")) || a(b.target).is(a(".card .card-title i")) || a(b.target).is(a(".card .card-image"))) && a(this).find(".card-reveal").velocity({translateY: "-100%"}, {
                duration: 300,
                queue: !1,
                easing: "easeOutQuad"
            }))
